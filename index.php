...
if(count($_POST)>0) {
	...
	$customers = DAL::getCustomers()->selectOneByEmail($email);    ///DAL:: for calling static functions 
...
<body class="container-fluid">
    <section class="col-lg-12 col-md-12 col-sm-12 col-xs-12 none login">
        ...
        <div class="col-lg-5 col-md-4 col-sm-6 col-xs-10 middle">
            ...
            <p class="text-center"><a class="chup" href="forgetPassword.php">Forget Password</a></p>	
        </div>
