...
<div class="container">
  ...
  <select  id="user" name="user" class="btn btn-default" style="">
...
if(isset($_GET['user']))
{
  ...
  $order->check_orders(false,$_GET['user'],$_GET['date_from'],$_GET['date_to']);
  else if($_GET['user']!="" && ($_GET['date_from']=="" || $_GET['date_to']==""))
    $order->check_orders(false,$_GET['user'],false,false);
  else if($_GET['user']=="" && ($_GET['date_from']!="" && $_GET['date_to']!=""))
